    ...
    <li class="menu-item active open">
        ...
        <ul class="menu-sub">
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                    <li class="menu-item">
                        <a href="{{ route('systemroles.admin.roles') }}" class="menu-link">
                            <div class="d-flex justify-content-between w-100 align-items-center" data-i18n="Groups">
                                System Roles</div>
                        </a>
                    </li>
                    <li class="nav-item"><a class="nav-link active" href="{{ route('systemroles.admin.roles') }}"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Roles</a></li>
                    <li class="nav-item"><a class="nav-link " href="{{  route('systemroles.admin.roles.permissions') }}"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Permissions</a></li>
                    <li class="nav-item"><a class="nav-link " href="{{  route('systemroles.admin.roles.users') }}"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Users</a></li> 
                    <li class="nav-item"><a class="nav-link " href="{{  route('systemroles.admin.roles.classes.index') }}') }}"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Classes</a></li> 
