...
<head>
    ...
    <link href="{{ asset('vendor/systemroles/fonts/fontawesome/4.7.0/css/font-awesome.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('vendor/systemroles/fonts/remixicon/remixicon.css') }}" rel="stylesheet">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="#">
                <img src="{{ asset('vendor/systemroles/images/logo/systemroles-logo.png') }}" alt="SystemRoles Logo">
